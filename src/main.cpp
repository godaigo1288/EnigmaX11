...
unsigned int nTargetSpacing = 2 * 60; // 120 secs
unsigned int nStakeMinAge = 60 * 60 * 12; // 6 hours
...
const string strMessageMagic = "EnigmaX11 Signed Message:\n";
...
static const int64_t nTargetTimespan = 2 * 60;  // every blok
//
...
// EnigmaX11: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EnigmaX11", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Enigma X11!";
        CTransaction txNew;
        txNew.nTime = 1422809999;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xfa5475e130351d1b218ec860853c62455c397d2a489b389ba5408f4cdfa98043"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf2, 0x2f, 0xa3, 0x75 };
